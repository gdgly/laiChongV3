...
class CreateQianNiuChargeOrderMappingsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('qianniu_charge_order_mappings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('qianniu_charge_order_mappings');
    }
}
