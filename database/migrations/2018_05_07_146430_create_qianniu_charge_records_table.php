...
class CreateQianNiuChargeRecordsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('qianniu_charge_records', function (Blueprint $table) {
            ...
            $table->tinyInteger('startup_type')->unsigned()->default(0)->comment('启动类型 0/线上启动 1/刷卡启动 2/投币启动');
