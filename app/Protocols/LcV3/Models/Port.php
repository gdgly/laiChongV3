...
class Port extends Model
{
    ...
    protected $fillable = ['id','evse_id','code', 'monitor_code', 'port_number','monitor_order_id','order_id','work_status','is_fuse',
        ...
        'renew', 'is_response', 'operation_time', 'left_time','current','response_time', 'start_charge_type','balance','duration','card_num'
    ...
    public function evse(){
        return $this->belongsTo(\Wormhole\Protocols\QianNiu\Models\Evse::class);
    }
}
